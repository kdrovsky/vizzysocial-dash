  ...
  const handleAddCard = async () => {
    ...
    if (user) {
      if (cardRef) {
        ...
        let updateCustomerPaymentMethodRes = await axios.post(`${process.env.REACT_APP_BASE_URL}/api/chargebee/updateCustomerPaymentMethod`,
  ...
  const handleCardPay = async () => {
    ...
    if (user) {
      ...
      if (cardRef) {
        ...
        let createCustomer = await axios.post(`${process.env.REACT_APP_BASE_URL}/api/chargebee/create_customer_and_subscription`,
          urlEncode(create_customer_data))
        ...
        if (createCustomer.message === 'success') {
          ...
          if (!customer_id) {
            let getCustomer = await axios.post(`${process.env.REACT_APP_BASE_URL}/api/chargebee/customer_list`, { email: user?.email })
